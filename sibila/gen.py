...
class GenOut:
    ...
    obj: Union[Any, None] = None # Any = dataclass or Pydantic BaseModel object
    """Initialized dataclass or Pydantic BaseModel object return in calls like gen_dataclass()."""
